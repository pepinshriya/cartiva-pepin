      ...
      <div className="container">
        ...
        <div className={styles.layout}>
              ...
              >
                ...
                <div className={styles.row}>
                  ...
                  <div className={styles.field}>
                    ...
                    />
                    {fieldErrors.zip && (
                      <span className={styles.fieldError}>{fieldErrors.zip}</span>
                    )}
                  </div>
                </div>
                <motion.button
              ...
              >
                ...
                <div className={styles.field}>
                  ...
                  <input
                    ...
                    className={fieldErrors.cardName ? styles.inputError : ''}
                  />
                  {fieldErrors.cardName && (
                    <span className={styles.fieldError}>{fieldErrors.cardName}</span>
                  )}
                </div>
                <div className={styles.field}>
                  ...
                  <input
                    ...
                    className={fieldErrors.cardNumber ? styles.inputError : ''}
                  />
                  {fieldErrors.cardNumber && (
                    <span className={styles.fieldError}>{fieldErrors.cardNumber}</span>
                  )}
                </div>
                <div className={styles.row}>
                  <div className={styles.field}>
                    ...
                    <input
                      ...
                      className={fieldErrors.expiry ? styles.inputError : ''}
                    />
                    {fieldErrors.expiry && (
                      <span className={styles.fieldError}>{fieldErrors.expiry}</span>
                    )}
                  </div>
                  <div className={styles.field}>
                    <label>CVV</label>
                    <input
                      ...
                      className={fieldErrors.cvv ? styles.inputError : ''}
                    />
                    {fieldErrors.cvv && (
            ...
            {step === 3 && (
              ...
              >
                ...
                <div className={styles.reviewSection}>
                  ...
                  <p>
                    {form.firstName} {form.lastName}, {form.address}, {form.city}, {form.state}{' '}
                    {form.zip}
                  </p>
                </div>
                <div className={styles.reviewSection}>
                ...
                <div className={styles.btnRow}>
                  <button className={styles.backBtn} onClick={() => setStep(2)} disabled={loading}>
                    Back
                  </button>
                  <motion.button
          ...
          <div className={styles.summary}>
            <h3>Order Summary</h3>
            <p className={styles.summaryItemCount}>
